...
Dromon is configured solely through environment variables. There is a default for every variable. So all are optional.
...
| BASE\_URL | [http://localhost:8080](http://localhost:8080) |  | The URL under which Dromon is accessible by clients. The [FHIR RESTful API](https://www.hl7.org/fhir/http.html) will be accessible under `BASE_URL/fhir`. |
